        ...
        <section id='section-1'>
          <nav>
            <div className="nav-eleme">
              <svg xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 401.23099 116.838">
                ...
                <path d="M100.972,107.872h27.078v-10.6516h-24.33701v-8.0222h21.37v-10.112h-21.37v-7.348h23.73v-10.6513h-36.47099v46.7851Z"></path>
            ...
            <div className="nav-eleme"><i className="ri-arrow-drop-right-line"></i>Our Showreel</div>
            <div className="nav-eleme">
          ...
          <div className="bottom">
            ...
            <div className="right">
              ...
              <p className='p3'>
                Facebook <span className="slash">/</span>
                Instagram <span className="slash">/</span>
                Dribbble <span className="slash">/</span>
                Twitter <span className="slash">/</span>
                Newsletter
              </p>
            </div>
          </div>
          ...
          <div className="top">
            ...
            <div>
              ...
              <div className="sub-bottom">
                Fb <span>/</span> Ins <span>/</span> Dri <span>/</span> Tw
              </div>
            </div>
          </div>
          <div className="bottom">
